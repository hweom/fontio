...
namespace fontio { namespace model { namespace cff
{
    ...
    private:
        ...
        static const std::vector<std::string>& GetStandardStrings()
        {
            static std::vector<std::string> strings = CreateStandardStrings();

            return strings;
        }

        static std::vector<std::string> CreateStandardStrings()
        {
